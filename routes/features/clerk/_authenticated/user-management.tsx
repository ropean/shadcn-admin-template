...
export const Route = createFileRoute('/features/clerk/_authenticated/user-management')({
...
function Unauthorized() {
  ...
  useEffect(() => {
    ...
    navigate({ to: '/features/clerk/sign-in' })
  }, [countdown, navigate])
    ...
    <div className='h-svh'>
      <div className='m-auto flex h-full w-full flex-col items-center justify-center gap-2'>
        ...
        <div className='mt-6 flex gap-4'>
          ...
          <Button onClick={() => navigate({ to: '/features/clerk/sign-in' })}>
